  ...
  },
  {
    ...
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.894 7.5c.051.34.051 2.186.051 5.5s0 5.16-.051 5.5c-.09 1.338-.557 2.286-1.444 3.173-.887.887-1.835 1.354-3.173 1.444-.34.051-2.186.051-5.5.051s-5.16 0-5.5-.051c-1.338-.09-2.286-.557-3.173-1.444-.887-.887-1.354-1.835-1.444-3.173C2.051 17.16 2.051 15.314 2.051 12s0-2.186.051-5.5c.09-1.338.557-2.286 1.444-3.173.887-.887 1.835-1.354 3.173-1.444.34-.051 2.186-.051 5.5-.051s5.16 0 5.5.051c1.338.09 2.286.557 3.173 1.444.887.887 1.354 1.835 1.444 3.173z" />
        <circle cx="12" cy="12" r="3.5" fill="#0B0B0F" />
      </svg>
    ),
